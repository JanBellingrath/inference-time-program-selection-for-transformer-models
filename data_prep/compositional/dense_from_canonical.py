...
from data_prep.common.io import read_jsonl, save_torch
...
def build_dense(
    ...
    *,
    ...
    max_qid = -1
    canon_rows = read_jsonl(canonical_jsonl_path)
    ...
    validate_dense_shape(delta_matrix, anchor_utilities)
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    save_torch(args.output, payload)
    print(
        "wrote",
        args.output,
        "shape",
